...
FORBIDDEN_VERBS = ["consider", "ensure", "implement"]

CORPORATE_SPEAK = [
    "leverage", "synergy", "paradigm", "streamline", "best-in-class",
...
RULE_CHECKS: list[tuple[str, callable, bool]] = [
    ...
    ("no_forbidden_verbs", lambda t: any(re.search(r'\b' + v + r'\b', t, re.I) for v in FORBIDDEN_VERBS), False),
